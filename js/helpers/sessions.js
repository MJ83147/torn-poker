// ── Session grouping (shared by mygame panel + insight engine) ─────────────
...
// return a list of human-readable patterns (e.g. "Played looser than usual").
...
// Render the Best & Worst Sessions block. Returns HTML or '' if there aren't
// enough sessions to compare. Wires "Show hands played" buttons to
...
function renderBestWorstSessions(hands, overallData) {
  ...
  // Handle ties: prefer more hands so the comparison surfaces the more
  // meaningful session.
  var best = sessions[0];
...
// Sessions shorter than minSession are skipped (too small to halve meaningfully).
