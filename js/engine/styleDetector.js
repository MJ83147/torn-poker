// ── STYLE DETECTOR ───────────────────────────────────────────────────────────
// Classify the player's actual play into one of seven archetypal styles based
...
//   Shark  : VPIP in [14, 25] AND AF >= 25  (TAG)
//   Rock   : VPIP in [14, 25] AND AF < 25
//   Nit    : VPIP < 14
//
// Confidence:
//   high   : >= 100 hands
...
function _styleReason(name, vpip, af, pfr) {
  ...
  if (name === 'Shark') return v + ' and ' + a + ', tight and aggressive.';
...
var STYLE_DESCRIPTIONS = {
  TAG:     'Tight-aggressive. Plays few hands, plays them hard. The default winning style.',
  ...
  Shark:   'Tight-aggressive. Plays few hands, plays them hard.',
  Cannon:  'Loose mid-aggression. Sees too many flops without enough follow-through.',
  Rock:    'Tight-passive. Selective preflop, but rarely takes the lead postflop.'
};
