...
function renderShowdown(container, hands, meta, overallData) {
  ...
  statsHtml += '<div class="eyebrow row center">' +
  ...
  potStatsHtml += '<div class="eyebrow">Avg Pot Won' +
  ...
  potStatsHtml += '<div class="eyebrow">Avg Pot Lost' +
  ...
  potStatsHtml += '<div class="eyebrow">Win/Loss Pot Ratio</div>';
